...
//         title: Center(child: Text('Water Detox', style: TextStyle(color: Colors.white),)), ),
...
//                 color: Colors.green,
//               ),
//               title: Center(child: const Text("Water Detox")),
//             ),
//           ),*/
//
//           SliverToBoxAdapter(
...
//                                   child: Text('Ingredients: Apple, Lemon, Carrot Ornge ', style: const TextStyle(color: Colors.green,fontSize: 20,fontWeight: FontWeight.bold),),
//                                 ),
...
//                                 const Padding(
//                                   padding: EdgeInsets.all(8.0),
//                                   child: Text('Ingredients: Cucumber, lemon, mint ', style: const TextStyle(color: Colors.green,fontSize: 20,fontWeight: FontWeight.bold),),
//                                 ),
//                                 const SizedBox(height: 1,),
//                                 Padding(
//                                   padding: const EdgeInsets.all(20.0),
...
//                                 const Padding(
//                                   padding: EdgeInsets.all(8.0),
//                                   child: Text('Ingredients: Apple, Cinnamon Stick ', style: const TextStyle(color: Colors.green,fontSize: 20,fontWeight: FontWeight.bold),),
//                                 ),
//                                 const SizedBox(height: 1,),
//                                 Padding(
//                                   padding: const EdgeInsets.all(20.0),
...
//                                 const Padding(
//                                   padding: EdgeInsets.all(8.0),
//                                   child: Text('Ingredients: Pineapple , sugar cane ', style: const TextStyle(color: Colors.green,fontSize: 20,fontWeight: FontWeight.bold),),
//                                 ),
//                                 const SizedBox(height: 1,),
//                                 Padding(
//                                   padding: const EdgeInsets.all(20.0),
...
//                                 const Padding(
//                                   padding: EdgeInsets.all(8.0),
//                                   child: Text('Ingredients: Kiwi, Orange ', style: const TextStyle(color: Colors.green,fontSize: 20,fontWeight: FontWeight.bold),),
//                                 ),
//                                 const SizedBox(height: 1,),
//                                 Padding(
//                                   padding: const EdgeInsets.all(20.0),
...
//                                 const Padding(
//                                   padding: EdgeInsets.all(8.0),
//                                   child: Text('Ingredients: Cranberry and mint ', style: const TextStyle(color: Colors.green,fontSize: 20,fontWeight: FontWeight.bold),),
//                                 ),
//                                 const SizedBox(height: 1,),
//                                 Padding(
//                                   padding: const EdgeInsets.all(20.0),
...
//                                 const Padding(
//                                   padding: EdgeInsets.all(8.0),
//                                   child: Text('Ingredients: Lemon and ginger ', style: const TextStyle(color: Colors.green,fontSize: 20,fontWeight: FontWeight.bold),),
//                                 ),
//                                 const SizedBox(height: 1,),
//                                 Padding(
//                                   padding: const EdgeInsets.all(20.0),
...
//                                 const Padding(
//                                   padding: EdgeInsets.all(8.0),
//                                   child: Text('Ingredients:Raspberry and orange ', style: const TextStyle(color: Colors.green,fontSize: 20,fontWeight: FontWeight.bold),),
//                                 ),
//                                 const SizedBox(height: 1,),
//                                 Padding(
//                                   padding: const EdgeInsets.all(20.0),
...
//                                 const Padding(
//                                   padding: EdgeInsets.all(8.0),
//                                   child: Text('Ingredients: strawberry  ', style: const TextStyle(color: Colors.green,fontSize: 20,fontWeight: FontWeight.bold),),
//                                 ),
//                                 const SizedBox(height: 1,),
//                                 Padding(
//                                   padding: const EdgeInsets.all(20.0),
...
//                                 const Padding(
//                                   padding: EdgeInsets.all(8.0),
//                                   child: Text('Ingredients: Watermelon with mint  ', style: const TextStyle(color: Colors.green,fontSize: 20,fontWeight: FontWeight.bold),),
//                                 ),
//                                 const SizedBox(height: 1,),
//                                 Padding(
//                                   padding: const EdgeInsets.all(20.0),
...
//                                 const Padding(
//                                   padding: EdgeInsets.all(8.0),
//                                   child: Text('Ingredients:pineapple and ginger ', style: const TextStyle(color: Colors.green,fontSize: 20,fontWeight: FontWeight.bold),),
//                                 ),
//                                 const SizedBox(height: 1,),
//                                 Padding(
//                                   padding: const EdgeInsets.all(20.0),
...
//                                 const Padding(
//                                   padding: EdgeInsets.all(8.0),
//                                   child: Text('Ingredients:Parsley with lemon', style: const TextStyle(color: Colors.green,fontSize: 20,fontWeight: FontWeight.bold),),
//                                 ),
//                                 const SizedBox(height: 1,),
//                                 Padding(
//                                   padding: const EdgeInsets.all(20.0),
...
//                                 const Padding(
//                                   padding: EdgeInsets.all(8.0),
//                                   child: Text('Ingredients: Orange, berries', style: const TextStyle(color: Colors.green,fontSize: 20,fontWeight: FontWeight.bold),),
//                                 ),
//                                 const SizedBox(height: 1,),
//                                 Padding(
//                                   padding: const EdgeInsets.all(20.0),
...
//                                 const Padding(
//                                   padding: EdgeInsets.all(8.0),
//                                   child: Text('Ingredients: Lemon , orange', style: const TextStyle(color: Colors.green,fontSize: 20,fontWeight: FontWeight.bold),),
//                                 ),
//                                 const SizedBox(height: 1,),
//                                 Padding(
//                                   padding: const EdgeInsets.all(20.0),
...
//                                 const Padding(
//                                   padding: EdgeInsets.all(8.0),
//                                   child: Text('Ingredients: Cucumber,strawberry', style: const TextStyle(color: Colors.green,fontSize: 20,fontWeight: FontWeight.bold),),
//                                 ),
//                                 const SizedBox(height: 1,),
//                                 Padding(
//                                   padding: const EdgeInsets.all(20.0),
